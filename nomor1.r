...
location <- '~/Documents/Pasca/tugas/sem2/pola/pola uts/Pak Ashar/Data/Pola_Wajah/'
...
location1 <- '~/Documents/Pasca/tugas/sem2/pola/pola uts/Pak Ashar/Data/Pola_NonWajah/'

panjang2 <- 0

for(i in 1:75){
  z <- readImage(files = paste(location1,i,".jpg",sep = ""))
